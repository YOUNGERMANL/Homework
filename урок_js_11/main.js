...
let discount = age > 65 ? 30 : age >= 18 ? 20 : age < 18 ? 10 : 0;
console.log(`Ваша скидка равна ${discount}%`);
...
const username = prompt("Введите username", "user type");
const password = +prompt("Введите password", "123");

let data = (username == "admin" || username == "user" ) && password == 123456 ? "Доступ разрешен" : "Доступ запрещен";
console.log(data);
...
const weight = +prompt("Введите вес доставки (в килограммах)", 0);
const deliverTtype = prompt("Укажите тип доставки (Стандарт, Экспресс, Премиум)", "Стандарт");
let coefficient;
let result;
...
let price = 0 < weight && weight <= 1 ? 5 : weight >= 1 && weight <= 10 ? 10 : weight > 5 ? 15 : 0;

if (deliverTtype != "Стандарт" &&  deliverTtype != "Экспресс" && deliverTtype != "Премиум") {
